    ...
    <span className={styles.servicesGrid__linkGlyph} aria-hidden="true">
      <svg viewBox="0 0 26 26" width="26" height="26" focusable="false">
        ...
        <rect
          ...
          fill="currentColor"
        />
        <rect x="10" y="14.667" width="3.333" height="3.333" fill="currentColor" />
      </svg>
    </span>
  );
}
      ...
      <div className={styles.servicesGrid__inner}>
        ...
        <ul className={styles.servicesGrid__cards} role="list">
          {cards.map((card, index) => (
            <li key={card.title} className={styles.servicesGrid__card}>
              <p className={styles.servicesGrid__cardNumber} aria-hidden="true">
              ...
              <a className={styles.servicesGrid__cardLink} href={card.link.href}>
                <LinkGlyph />
                {card.link.label}
